...
If you want to develop based on `ttc`, follow instructions from [utils/install.md](https://github.com/meelgroup/ttc/blob/main/utils/install.md).
...
The benchmarks used in our evaluation can be found [here](https://zenodo.org/records/16782811).lla